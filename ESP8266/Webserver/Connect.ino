...
const char* ssid = "IBIS";              // Darf bis zu 32 Zeichen haben.
const char* password = "";   // Mindestens 8 Zeichen jedoch nicht länger als 64 Zeichen.
//const char* ssid = "iPhone von Joachim";              // Darf bis zu 32 Zeichen haben.
//const char* password = "123nobody45";   // Mindestens 8 Zeichen jedoch nicht länger als 64 Zeichen.
